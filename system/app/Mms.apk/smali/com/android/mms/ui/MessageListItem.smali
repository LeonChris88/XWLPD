...
.field private mOldFontSizeIndex:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Lcom/android/mms/ui/MessageListItem;->mOldFontSizeIndex:I
...
.method private isTextSizeDecreased(I)Z
    .locals 4

    const/4 v0, 0x0

    iget v1, p0, Lcom/android/mms/ui/MessageListItem;->mOldFontSizeIndex:I

    const/4 v2, -0x1

    if-ne v1, v2, :cond_0

    iput p1, p0, Lcom/android/mms/ui/MessageListItem;->mOldFontSizeIndex:I
    ...
    const-string v3, "isTextSizeDecreased() : result "
...
.method public bind(Lcom/android/mms/ui/MessageItem;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    iget-object v7, p0, Lcom/android/mms/ui/MessageListItem;->mMsgListItem:Landroid/view/View;
    ...
    iget-object v6, p0, Lcom/android/mms/ui/MessageListItem;->mFailedIcon:Landroid/widget/Button;
    ...
    invoke-static {v6}, Lcom/android/mms/ui/MessagingPreferenceActivity;->getMessageFontSizeIndex(Landroid/content/Context;)I

    move-result v0

    invoke-direct {p0, v0}, Lcom/android/mms/ui/MessageListItem;->isTextSizeDecreased(I)Z
    ...
    invoke-virtual {p0, v6}, Lcom/android/mms/ui/MessageListItem;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v5, v4}, Landroid/widget/LinearLayout;->indexOfChild(Landroid/view/View;)I
    ...
    iput-object v3, p0, Lcom/android/mms/ui/MessageListItem;->mBodyTextView:Landroid/widget/TextView;
    ...
    iget-object v6, p0, Lcom/android/mms/ui/MessageListItem;->mBubbleLayout:Landroid/widget/LinearLayout;

    const/4 v7, 0x0

    invoke-virtual {v6, v7}, Landroid/widget/LinearLayout;->setOnCreateContextMenuListener(Landroid/view/View$OnCreateContextMenuListener;)V
    ...
    iget-object v7, p0, Lcom/android/mms/ui/MessageListItem;->mOnClickListener:Landroid/view/View$OnClickListener;
    ...
    iget-object v7, p0, Lcom/android/mms/ui/MessageListItem;->mMsgListMenuCreateListener:Landroid/view/View$OnCreateContextMenuListener;
    ...
    iget-object v7, p0, Lcom/android/mms/ui/MessageListItem;->mFailedIconClickListener:Landroid/view/View$OnClickListener;

    invoke-virtual {v6, v7}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v6, p0, Lcom/android/mms/ui/MessageListItem;->mBodyTextView:Landroid/widget/TextView;

    iget-object v7, p0, Lcom/android/mms/ui/MessageListItem;->mOnBodyTextTouchListener:Landroid/view/View$OnTouchListener;
    ...
    sget v7, Lcom/android/mms/ui/MessagingPreferenceActivity;->BUBBLE_DATE_SIZE_TINY_U1:F
    ...
    sget v7, Lcom/android/mms/ui/MessagingPreferenceActivity;->BUBBLE_DATE_SIZE_SMALL_U1:F
    ...
    sget v7, Lcom/android/mms/ui/MessagingPreferenceActivity;->BUBBLE_DATE_SIZE_NORMAL_U1:F
    ...
    sget v7, Lcom/android/mms/ui/MessagingPreferenceActivity;->BUBBLE_DATE_SIZE_LARGE_U1:F
    ...
    sget v7, Lcom/android/mms/ui/MessagingPreferenceActivity;->BUBBLE_DATE_SIZE_HUGE_U1:F
